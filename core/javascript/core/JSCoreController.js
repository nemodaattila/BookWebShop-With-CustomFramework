...
class JSCoreController {
     ...
     */
    loadScriptFiles() {
        if (this._model.modulLoaderFileExists[0]) {
            this._includer.addFilesToLoad(["modulloader.js"], this._model.javascriptUrl + '/modulloader/', 0);
        }
        if (this._model.modulLoaderFileExists[1]) {
            this._includer.addFilesToLoad(["modulloader.js"], this._model.pageUrl, 0);
        }
        if (this._model.initiatorFileExists[0]) {
            this._includer.addFilesToLoad(["initiator.js"], this._model.javascriptUrl + '/initiator/', 2);
        }
        if (this._model.initiatorFileExists[1]) {
            this._includer.addFilesToLoad(["initiator.js"], this._model.pageUrl, 2);
        }
    }
