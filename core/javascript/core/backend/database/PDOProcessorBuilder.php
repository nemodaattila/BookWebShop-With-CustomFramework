...
use core\backend\database\queryProcessor\simple\SimplePDOProcessorParent;
...
final class PDOProcessorBuilder
{
     ...
     * @return IPDOQueryProcessorInterface a PDO kezelő osztály
     * @throws RequestResultException ha a $type nem valamelyik: ['Insert','Select','Update','Delete']
     */
    public static function getProcessor(string $type, bool $simple = false): IPDOQueryProcessorInterface | SimplePDOProcessorParent
    {
        $type = ucfirst(strtolower($type));
        if (!in_array($type,['Insert','Select','Update','Delete']))
        {
