...
/**
 * Class BookListDBHandler összetett keresési feltételek alapján ad vissza feltételeknek megfelelő könyvek isbn-listáját
 * @package project\backend\model\dbHandler
 */
class BookListDBHandler
{
    /**
     * megadott paraméterek alaőján összeállítja a lekérdező PDO sql query-t, és visszaadja az isbnlistát
     * valamint az összes kritériumnak megfelelő könyv darabszámát
     * @param array $parameters keresési paraméterek, html requestben érkezik
     * @return array ['list'=><isbnlist [array] >, 'count'=> <összes megfelelő darabszám> ]
     * @throws RequestResultException PDOPRocesszor hiba , paraméter konvertálási hiba
     */
    #[ArrayShape(['list' => "array", 'count' => "int"])] public function getBookList(array $parameters): array
    {
