 ...
 * lekéri egy könyv elsődleges adatait adatbázisból, amik általában egy gyorsböngészés során megjelenhetnek |
 * isbn, cim, tipus_id, kategória_id, iró(k), ár, kedvezmény, boritó (thumbnail, base64string)
 */
class BookDataDBHandler
{
    /**
